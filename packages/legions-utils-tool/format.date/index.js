...
function formatDateToFriendly(date) {
    ...
    invariant(date instanceof Date, 'date is not date type');
    var now = new Date();
    if ((now.getTime() - date.getTime()) < 60 * 1000 && (now.getTime() - date.getTime()) >= 0)
...
export { countDays, formatDate, formatDateToFriendly, formatDurationToFriendly, formatTimeToFriendly, getLastDay, getMonthDays, isLeapYear, parseDate };

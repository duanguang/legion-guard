...
(function (global, factory) {
	...
	var stateMachine$1 = unwrapExports(stateMachine);

	//@ts-ignore
	var StateMachine = stateMachine$1;
	var firstUpperCase = function (str) {
	    return str.replace(/\b(\w)(\w*)/g, function ($0, $1, $2) {
	        return $1.toUpperCase() + $2.toLowerCase();
	    });
	};
	function stateMachine$2(options) {
	    var fsm = new StateMachine(options);
	    //@ts-ignore
	    return {
	        fsm: fsm,
	        exceMethod: function (name) {
	            fsm[name] && fsm[name]();
	        },
	        /**
	         * 执行监听订阅函数
	...
	exports.stateMachine = stateMachine$2;

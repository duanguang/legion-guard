...
function () {
  ...
  BaseFormFields.dataToFormFields = function (formFields, data) {
    ...
    Object.keys(formFields).forEach(function (key) {
      ...
      if (formFields[key]['beforeDataToFormFields'] && typeof formFields[key]['beforeDataToFormFields'] === 'function') {
        obj[key] = {
          value: formFields[key]['beforeDataToFormFields'](data[RequestParamKey], data)
        };
      } else {
        obj[key] = {
          value: data[RequestParamKey]
        };
      }
    });
    return obj;
  ...
  BaseFormFields.formFieldsToData = function (formFields, values) {
    ...
    if (typeof model === 'function') {
      // @ts-ignore
      model = new formFields(); // @ts-ignore
    ...
    Object.keys(model).forEach(function (key) {
      ...
      if (model[key]['submitBeforeTransform'] && typeof model[key]['submitBeforeTransform'] === 'function') {
  ...
  BaseFormFields.initMapPropsToFields = function (form) {
    ...
    if (form && this) {
      Object.keys(form).forEach(function (item) {
        _this[item] = __assign(__assign({}, form[item]), {
